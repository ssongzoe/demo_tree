...
실행:
python test/tote_xy_auto_calibration_dual_v2.py --serial 250122079439
"""
...
from utils.tote_vision import detect_frame_feature, draw_feature, start_camera
...
WINDOW_NAME = "Tote DUAL XY Auto Calibration v2"

# dual yaw calibration v3 결과
# 단위: [px/deg, px/deg, deg/deg]
J_LEFT_YAW = np.asarray([+7.631325, -2.982619, +0.678178], dtype=np.float64)
J_RIGHT_YAW = np.asarray([+9.610277, +3.014138, +0.354167], dtype=np.float64)
...
def main():
    ...
    try:
        ...
        print()
        print("==============================================================")
        print("        TOTE DUAL AUTO X/Y CALIBRATION v2")
        print("==============================================================")
